...
public interface PurchaseRepository extends JpaRepository<Purchase, Long> {
	@Query(value = "SELECT * FROM purchase p " + "INNER JOIN goods g " + "ON p.goods_id = g.id "
			+ "WHERE created_at = ("
	...
	@Transactional
	@Modifying
	void persist(@Param("userId") long userId, @Param("goodsId") long goodsId, @Param("goodsName") String goodsName,
			@Param("itemCount") long itemCount, @Param("total") long total);
